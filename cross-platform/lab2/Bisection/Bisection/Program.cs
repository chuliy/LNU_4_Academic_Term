...
namespace Bisection
{
    class Bisection
    {
        ...
        {
            return Math.Pow(Math.E, -x) - Math.Log10(1 - Math.Pow(x, 2)) - 2.0;
        }
        ...
        public static void bisection(double a, double b,double EPSILON)
        {
            ...
            //Console.WriteLine("The value of root is : " + c + " ;cnt = " + cnt);
            Console.WriteLine("x = " + c);
            Console.WriteLine("x = {0:F2}",c);
            Console.WriteLine("f(x) = " + func(c));
            
            Console.WriteLine("number of iterations =" +cnt);
